   ...
   void _calculate() {
    setState(() {
      ...
      if (imc < 18.6) {
        ...
        _infoTexto = "Obsidade Grau I (${imc.toStringAsPrecision(3)})";
      } else if (imc >= 34.9 && imc < 39.9) {
        _infoTexto = "Obsidade Grau II (${imc.toStringAsPrecision(3)})";
      } else if (imc >= 40.0) {
        _infoTexto = "Obsidade Grau III (${imc.toStringAsPrecision(3)})";
      }
    });
  }
